...
impl ElfFile {
  ...
  /// get_aligned_data_offset takes in the length of the text section and returns the memory
  /// address of the data section after the elf file was loaded.
  pub fn get_aligned_data_offset(text_len: u64) -> u64 {
    let text_aligned_size = (text_len + ALIGNMENT - 1) & !(ALIGNMENT - 1);
    KERNEL_MIN_LOAD_ADDRESS + text_aligned_size
  }
